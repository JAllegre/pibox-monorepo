...
// RECIPE API
miamRouter.get(`${RECIPES_API}`, async (_req: Request, res: Response, next: NextFunction) => {
  try {
...
miamRouter.get(`${RECIPES_API}/:recipeId`, async (req: Request, res: Response, next) => {
  try {
...
miamRouter.post(`${RECIPES_API}`, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
miamRouter.post(`${RECIPES_API}/check-pwd`, async (req: Request, res: Response, next: NextFunction) => {
  try {
